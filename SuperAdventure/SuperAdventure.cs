...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
        ...
        private void BindInventoryDataToUI()
        {
        ...
        private void BindQuestDataToUI()
        {
        ...
        private void UpdateWeaponListInUI()
        {
            ...
            if (weapons.Count == 0)
            {
                // The player does not have any weapons, so hide the the weapon combobox and "Use" button
                cboWeapons.Visible = false;
                btnUseWeapon.Visible = false;
            }
            else
        ...
        private void UpdatePotionsListInUI()
        {
            ...
            {
                // Player does not have any potions, so hide combobox and "Use" button
                cboPotions.Visible = false;
                btnUsePotion.Visible = false;
            }
            else
        ...
        private void BtnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            if (_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                // Add items to the lootedItems list, compating a random number to the drop percentage
                ...
                // Add a blank line to the messages box, just for appearances
                rtbMessages.Text += Environment.NewLine;
                ScrollToBottomOfMessages();

                // Move player to current location (to heal and spawn a new monster to fight)
                MoveTo(_player.CurrentLocation);
            }
            else
            {
